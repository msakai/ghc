...
## 4.24.0.0 *TBA*
  ...
  * Flush partially converted input at the end of the stream when encoding *and* decoding text, fixing incomplete output for some iconv-based encodings (e.g. `EUC-JISX0213`, `ISO-2022-JP` when encoding; `CP1255`, `CP1258`, `BIG5-HKSCS` when decoding). The internal `GHC.IO.Encoding.Types.BufferCodec` record gains a `finish#` field. (#15553)
